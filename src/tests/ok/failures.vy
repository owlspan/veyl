// An action that fails can now say why.
//
// These used to return a bare bool, so "permission denied", "no such
// directory" and "disk full" were all just false. They return void!
// now: either it worked, or there is a reason it did not.
...
// ? propagates the reason out of a function that returns nothing.
fn saveBoth(dir: str) -> void! {
    os.file.write(dir + "/a.txt", "a")?
    os.file.write(dir + "/b.txt", "b")?
    return ok()
}
